...
![Manhattan Plot](https://github.com/bradverhulst/gwsem/blob/master/exampleFigs/addFacOrdManhattan.png)
...
If you have suggestions or requests for software integration, please contact us and we will see what we can do (But be aware that the software is still under development and we may not be able to get to the request immediately).
